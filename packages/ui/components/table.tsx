...
function TableFooter({ className, ...props }: React.ComponentProps<'tfoot'>): React.JSX.Element {
  return (
    <tfoot
      ...
      className={cn(
        'border-border bg-surface-elevated border-t font-medium [&>tr]:last:border-b-0',
        className,
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<'tr'>): React.JSX.Element {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        'border-border hover:bg-surface-hover/50 data-[state=selected]:bg-surface-hover border-b transition-colors',
        className,
      )}
      {...props}
    />
...
function TableHead({ className, ...props }: React.ComponentProps<'th'>): React.JSX.Element {
  return (
    <th
      ...
      className={cn(
        'text-muted-foreground h-9 whitespace-nowrap px-3 text-left align-middle text-[11px] font-medium uppercase tracking-wider',
