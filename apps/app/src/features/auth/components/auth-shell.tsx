...
export function AuthShell() {
  ...
  return (
    <div className="text-foreground relative min-h-screen overflow-hidden bg-[#030408]">
      ...
      <main className="relative grid h-auto min-h-[calc(100vh-88px)] grid-cols-1 overflow-hidden lg:h-[calc(100vh-88px)] lg:grid-cols-[47.25%_52.75%]">
        <section className="border-border-subtle hidden h-full border-r px-16 py-12 lg:flex lg:flex-col xl:px-[76px]">
          <AuthBrand />
        ...
        <section
          className={cn(
            'flex min-h-[calc(100vh-88px)] items-center justify-center px-5 py-10 sm:px-8 lg:h-full lg:min-h-0 lg:items-start lg:px-12',
...
function getAuthMode(pathname: string): AuthMode {
  ...
  if (pathname.includes('forgot') || pathname.includes('reset')) return 'recovery';
  return 'login';
}
